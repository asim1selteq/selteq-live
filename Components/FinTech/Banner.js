...
function Banner() {
    return (
        <div className="col-md-12 px-0 background_white" >
            <div className={styles.solution_fintech_banner_background}>
                <div className="col-md-12 text_align_crousal text-center">
                    <h2 className="mb-0 font_crousal">FINTECH </h2>
                    <h6 className="display_pc font_wi_banner">FINTECH</h6>
                    <p className="size_12 display_h">Fully functional, smart and stylish apps to leave your customers awestruck</p>
                    <Link href="/contact-us" >
                        <button className="btn btn-light background_color_black mt-3 display_h"> LEARN MORE </button></Link>
                    <div className="col-md-12 p-0 display_pc text-center">
                        <Link href="/contact-us" >
                            <button className="btn btn-light background_color_black1 mt-3 "> LEARN MORE </button> </Link>
                    </div>
                </div>
            </div>
                    ...
                    <div className="row">
                        <div className="col-md-4 newdivhover px-0">
                            <div className="data_grid_banner">
                                ...
                                <div className="text-left" >
                                    <p className="style_patient_font mb-0 pt-1">Account&nbsp;Management</p>
                                    <p className="style_patient_font1 pt-2">Transaction&nbsp;&&nbsp;account&nbsp;processing</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-4">
                            <div className="data_grid_banner">
                                ...
                                <div className="text-left" >
                                    <p className="style_patient_font mb-0 pt-1">Security&nbsp;&&nbsp;Compliance</p>
                                    <p className="style_patient_font1 pt-2">Flexibly&nbsp;configurable&nbsp;&&nbsp;securely&nbsp;scalable</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-4">
                            <div className="data_grid_banner">
                                ...
                                <div className="text-left">
                                    <p className="style_patient_font mb-0 ">Digital&nbsp;Agility</p>
                                    <p className="style_patient_font1">Cash&nbsp;flow&nbsp;management&nbsp;&nbsp;POS&nbsp;optimization</p>
                                </div>
                            </div>
                        </div>
                    </div>
