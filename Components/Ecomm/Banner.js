        ...
        <div className="col-md-12 px-0 background_white" style={{ zIndex: 0 }}  >
            <div className={styles.solution_erp_banner_background}>
                <div className="col-md-12 text_align_crousal text-center">
                    <h2 className="mb-0 font_crousal">E-COMMERCE </h2>
                        ...
                        <div className="col-md-4 newdivhover px-0">
                            <div className="data_grid_banner">
                                ...
                                <div className="text-left" >
                                    ...
                                    <p className="style_patient_font1 pt-2">CRM,&nbsp;ERP&nbsp;&&nbsp;inventory&nbsp;management</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-4">
                            <div className="data_grid_banner">
                                ...
                                <div className="text-left" >
                                    ...
                                    <p className="style_patient_font1 pt-2">Control&nbsp;&&nbsp;manage&nbsp;the&nbsp;merchandize</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-4">
                            <div className="data_grid_banner">
                                ...
                                <div className="text-left" >
                                    <p className="style_patient_font mb-0 pt-1">Supply&nbsp;System</p>
                                    <p className="style_patient_font1 pt-2">Product&nbsp;supply&nbsp;&&nbsp;resupply&nbsp;system</p>
                                </div>
                            </div>
                        </div>
                    </div>
