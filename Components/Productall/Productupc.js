...
import Collapseproductc from "../Collapseall/Collapseproductc";
function Productupc() {
  ...
  return (
    <div className="col-md-12 p-0">
        <div className="col-md-12 text-center py-5 px-0 ">
            ...
            <h3><b>Better Way to Educate</b></h3>
            <h6 className="font_small_b">It’s not just software, it is a modern learning environment:</h6>
