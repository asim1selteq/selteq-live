        ...
        <div className="col-md-12 px-0 background_white" style={{ zIndex: 0 }} >
            <div className={styles.solution_medtech_banner_background}>
                <div className="col-md-12 text_align_crousal text-center">
                    <h2 className="mb-0 font_crousal">EDTECH </h2>
                    <h6 className="display_pc font_wi_banner">EDTECH</h6>
                    ...
                    <div className="row">
                        <div className="col-md-4 newdivhover px-0">
                            <div className="data_grid_banner">
                                ...
                                <div className="text-left" >
                                    <p className="style_patient_font mb-0 pt-1">Content&nbsp;Accessibility</p>
                                    <p className="style_patient_font1 pt-2">Course&nbsp;material&nbsp;&&nbsp;modules</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-4">
                            <div className="data_grid_banner">
                                ...
                                <div className="text-left" >
                                    <p className="style_patient_font mb-0 pt-1">Cost&nbsp;Reduction</p>
                                    <p className="style_patient_font1 pt-2">Planned&nbsp;eLearning&nbsp;environment</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-4">
                            <div className="data_grid_banner">
                                ...
                                <div className="text-left" >
                                    <p className="style_patient_font mb-0 pt-1">Student&nbsp;Portal</p>
                                    <p className="style_patient_font1 pt-2">Enterprise&nbsp;LMS&nbsp;&&nbsp;students’&nbsp;record</p>
                                </div>
                            </div>
                        </div>
                    </div>
