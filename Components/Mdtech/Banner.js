...
function Banner() {
    return (
        <div className="col-md-12 px-0 background_white" style={{ zIndex: 0 }} >
            <div className={styles.solution_medtech_banner_background}>
                <div className="col-md-12 text_align_crousal text-center">
                    <h2 className="mb-0 font_crousal">HEALTHCARE & MEDICAL </h2>
                    <h6 className="display_pc font_wi_banner">HEALTHCARE & MEDICAL</h6>
                    ...
                    <div className="row">
                        <div className="col-md-4 newdivhover px-0">
                            <div className="data_grid_banner">
                                ...
                                <div className="text-left" >
                                    <p className="style_patient_font mb-0 pt-1">Patient&nbsp;Monitoring</p>
                                    <p className="style_patient_font1 pt-2">Remote&nbsp;monitoring&nbsp;&&nbsp;lab&nbsp;results</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-4">
                            <div className="data_grid_banner">
                                ...
                                <div className="text-left" >
                                    <p className="style_patient_font mb-0 pt-1">EMR&nbsp;&&nbsp;EHR</p>
                                    <p className="style_patient_font1 pt-2">Streamlined&nbsp;clinical&nbsp;documentations</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-4">
                            <div className="data_grid_banner">
                                ...
                                <div className="text-left" >
                                    <p className="style_patient_font mb-0 pt-1">Billing&nbsp;Management</p>
                                    <p className="style_patient_font1 pt-2">RMS&nbsp;system&nbsp;&&nbsp;compliance&nbsp;reports</p>
                                </div>
                            </div>
                        </div>
                    </div>
