...
import Unlock from "../Components/MobileDesigns/Softwaredev/Unlock";
...
function Solutions() {
  ...
  return (
    <div className="col-md-12 p-0 background_hei">
      ...
      <div className={`col-md-12 p-0 display_h ${styles.background_learning}`}>
