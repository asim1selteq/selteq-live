      ...
      <div className='row pb-3 pt-5' >
        ...
        <div className="row">
                ...
                <div className="col-md-11 col-9 pl-0">
                    <p className="mb-0 heading_sol_sec">Account Management</p>
                    <p className="mt-0 sub_heading_sol_sec">Real-time transaction & account processing</p>
                </div>
            </div>
            <div className="row pt-2">
                ...
                <div className="col-md-11 col-9 pl-0">
                    <p className="mb-0 heading_sol_sec">Security & Compliance</p>
                    <p className="mt-0 sub_heading_sol_sec">Flexibly configurable & securely scalable</p>
                </div>
            </div>
            <div className="row pt-2">
                <div className="col-md-1 col-3 text-right">
                ...
                <div className="col-md-11 col-9 pl-0">
                    <p className="mb-0 heading_sol_sec">Digital Agility</p>
                    <p className="mt-0 sub_heading_sol_sec">Cash flow management & POS optimization</p>
                </div>
            </div>
        </div>
        <div className='col-md-2 col-2'></div>
