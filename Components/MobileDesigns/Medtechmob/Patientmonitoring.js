      ...
      <div className='row pb-3 pt-5' >
        ...
        <div className="row">
                ...
                <div className="col-md-11 col-9 pl-0">
                    <p className="mb-0 heading_sol_sec">PATIENT MONITORING</p>
                    <p className="mt-0 sub_heading_sol_sec">Remote monitoring & lab results</p>
                </div>
            </div>
            <div className="row pt-2">
                ...
                <div className="col-md-11 col-9 pl-0">
                    <p className="mb-0 heading_sol_sec">BILLING MANAGEMENT</p>
                    <p className="mt-0 sub_heading_sol_sec">RMS system & compliance reports</p>
                </div>
            </div>
            <div className="row pt-2">
                <div className="col-md-1 col-3 text-right">
                ...
                <div className="col-md-11 col-9 pl-0">
                    <p className="mb-0 heading_sol_sec">EMR & EHR</p>
                    <p className="mt-0 sub_heading_sol_sec">Streamline Clinical Documentation</p>
                </div>
            </div>
        </div>
        <div className='col-md-2 col-2'></div>
